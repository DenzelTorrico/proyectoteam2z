...
class SearchController extends Controller
{
    public function search(Request $request){
        ...
        return view('search.search',compact("buscar","categories","buscador"));
    }
    ...
    public function searchpricecategory(Request $request){
        ...
        return view("search.searchpricecategory",compact("categories","buscar","buscador"));
    }
    ...
    public function searchcategory(Request $request){
        ...
        return view('search.searchcategory',compact("categories","buscar","buscador"));
    }
